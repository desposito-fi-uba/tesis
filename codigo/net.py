...
class ConvDenoisingRealTimeNet(nn.Module):
    ...
    def __init__(self, time_feature_size, predict_on_time_windows):
        super().__init__()

        up = [(16, 32), (32, 64), (64, 128), (128, 256), (256, 512)]
        down = [(2 * 512, 256), (2 * 256, 128), (2 * 128, 64), (2 * 64, 32), (2 * 32, 16)]

        self.input_layer = self.build_input_layer(1, 16)
        encoder_layers = [
        ...
        self.middle_layer = self.build_block(512, 512)
        ...
        self.output_layer = self.build_output_layer(16, 1)
